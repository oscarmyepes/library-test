...
var JssContext = React__default['default'].createContext({
  classNamePrefix: '',
...
var useEffectOrLayoutEffect = isBrowser ? React__default['default'].useLayoutEffect : React__default['default'].useEffect;
var noTheme$1 = {};
...
var createUseStyles = function createUseStyles(styles, options) {
  ...
  function () {
    return React__default['default'].useContext(ThemeContext$1) || noTheme$1;
  } : // $FlowFixMe
  function () {
    return noTheme$1;
  };
  return function useStyles(data) {
    var isFirstMount = React__default['default'].useRef(true);
    var context = React__default['default'].useContext(JssContext);
    var theme = useTheme();
    ...
    React__default['default'].useDebugValue(classes); // $FlowFixMe

    React__default['default'].useDebugValue(theme === noTheme$1 ? 'No theme' : theme);
...
function (_Component) {
  ...
  function JssProvider() {
    ...
    _this.renderProvider = function (parentContext) {
      ...
      return React__default['default'].createElement(JssContext.Provider, {
        value: context
      }, children);
    };
  ...
  _proto.render = function render() {
    return React__default['default'].createElement(JssContext.Consumer, null, this.renderProvider);
  };
